...
const char * DL_PDU::getData() const
{
    return this->data.c_str();
}

void DL_PDU::setData(const char * data)
{
    this->data = data;
}

int DL_PDU::getType() const
{
    return this->type;
}

void DL_PDU::setType(int type)
{
    this->type = type;
}

int DL_PDU::getSource_address() const
{
    return this->source_address;
}

void DL_PDU::setSource_address(int source_address)
{
    this->source_address = source_address;
}

int DL_PDU::getDestination_address() const
{
    return this->destination_address;
}

void DL_PDU::setDestination_address(int destination_address)
{
